...
if ( ! function_exists( 'sample_theme_setup' ) ) :
	...
	function sample_theme_setup() {
		...
		register_nav_menus( array(
			// two underscores means it's text translation
...
/**
 * Custom template tags for this theme. for using functions in wordpress 
 */
require get_template_directory() . '/inc/template-tags.php';

/**
 * Functions which enhance the theme by hooking into WordPress. for using hooks (filters, actions) in wordpress
 */
